    ...
    for epoch in range(args.num_epochs):
        ...
        for i, batch in enumerate(train_dataloader) :
            ...
            if (mask[i] and epoch > 0):
                total_loss = total_loss * weight_estimation(total_loss, mean_epoch, std_epoch)
            
            memory_module[i, epoch] = total_loss
        ...
        print("# of batches", counter)
        print("Mem Module at Epoch", epoch)
        print(memory_module)
